export const countries = [
  ...
  { name: "Islas menores alejadas de EE. UU.", code: "UM" },
  { name: "Islas Norfolk", code: "NF" },
  ...
  { name: "Islas Vírgenes de EE. UU.", code: "VI" },
  { name: "Israel", code: "IL" },
  { name: "Italia", code: "IT" },
